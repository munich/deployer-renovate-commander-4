...
echo 'alias yoloswag="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/munich/deployer-renovate-commander-4.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/munich/deployer-renovate-commander-4.git'"
...
rm -rf "$HOME/.config/@yoloswag"
rm -rf "$HOME/.config/@yoloswag"
rm -rf "$HOME/.config/yoloswag-core"
